...
(Note: These URLs are ti test the functioning of the API on localhost. The APIs are hosted over the internet as well. Refer to the links in previous section for the same)
